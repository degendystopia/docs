...
export interface FixedPriceSellerInterface extends utils.Interface {
  functions: {
...
export interface FixedPriceSeller extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FixedPriceSellerInterface;
